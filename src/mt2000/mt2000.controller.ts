...
@Controller('mt2000')
export class Mt2000Controller {
    constructor(private readonly service: Mt2000Service, private readonly authService: AuthService) {}
    ...
    async command(@Body() req: commandDto) {
        return this.service.command(newDate(), req.commandName, req.place, req.idClient, req.idUser, req.command, req.serial)
    }
